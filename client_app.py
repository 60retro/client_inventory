...
if selected_tab:
    ...
    with st.form("stock_entry_form"):
        ...
        draft_btn = btn_cols[0].form_submit_button(t("save_draft"), use_container_width=True)
        submit_btn = btn_cols[1].form_submit_button(t("submit_btn"), type="primary", use_container_width=True)
